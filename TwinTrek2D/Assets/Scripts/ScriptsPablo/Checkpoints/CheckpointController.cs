...
public class CheckpointController : MonoBehaviour
{
    ...
    public void ReiniciarDesdeCheckpoint()
    {
        if (indiceCheckpointActivado >= 0)
        {
            ...
            jugadores[0].transform.position = new Vector3(posicionDeReinicio.x - 2f, posicionDeReinicio.y + 1f, posicionDeReinicio.z);
            jugadores[0].GetComponent<SpriteRenderer>().flipX = false;
            jugadores[1].transform.position = new Vector3(posicionDeReinicio.x + 2f, posicionDeReinicio.y + 1f, posicionDeReinicio.z);
