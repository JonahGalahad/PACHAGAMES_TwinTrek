...
public class EspirituDeFuegoScript : MonoBehaviour
{
    ...
    [SerializeField] private float ajusteAltura = 0.1f; // Ajusta este valor en el Inspector de Unity o directamente aqu�
    [SerializeField] private GameObject prefabFuego; // Prefab del sistema de part�culas de fuego
    [SerializeField] private float tiempoDeEspera = 1.5f; // Tiempo entre cada llamarada
    [SerializeField] private float distancia = 0.5f; // Distancia detr�s del esp�ritu donde aparecer� la llamarada
    ...
    {
        // La posici�n inicial de la llamarada ser� detr�s del esp�ritu, seg�n la �ltima direcci�n de movimiento
        ...
        {
            // Si el Raycast detecta el suelo, ajusta la posici�n 'y' de la llamarada al punto de impacto
            posicionFuego.y = hit.point.y + ajusteAltura; // Sube un poco la posici�n de la llamarada
        }
